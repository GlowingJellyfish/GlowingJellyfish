...
//
// Since GlowingJellyfish doesn't support exceptions all places where an exception
...
class NumaConfig {
   public:
    ...
    static NumaConfig from_system([[maybe_unused]] const NumaAutoPolicy& policy,
        ...
        // See https://github.com/official-glowingjellyfish/GlowingJellyfish/issues/5551
