...
template<GlowingJellyfish::Eval::NNUE::IndexType TransformedFeatureDimensions>
struct std::hash<GlowingJellyfish::Eval::NNUE::FeatureTransformer<TransformedFeatureDimensions>> {
    std::size_t
    operator()(const GlowingJellyfish::Eval::NNUE::FeatureTransformer<TransformedFeatureDimensions>& ft)
      const noexcept {
