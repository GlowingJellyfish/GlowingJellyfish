...
template<GlowingJellyfish::Eval::NNUE::IndexType L1, int L2, int L3>
struct std::hash<GlowingJellyfish::Eval::NNUE::NetworkArchitecture<L1, L2, L3>> {
    std::size_t
    operator()(const GlowingJellyfish::Eval::NNUE::NetworkArchitecture<L1, L2, L3>& arch) const noexcept {
